...
// FIX #1 — Wrap Firebase.initializeApp() in a timeout + error catch.
void main() async {
...
// ---------------------------------------------------------------------------
// Animated Splash Screen with PNG Effect & Slow Disappear
// ---------------------------------------------------------------------------
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // RBAC Security Check — block all admin roles from user login
      final role = data['role'] as String?;
      if (role == 'admin_l1' || role == 'admin_l2' || role == 'admin_l3' || role == 'dean') {
      ...
      if (mounted) _showSnackBar("Connection timed out. Please check your network and try again.");
    } catch (e) {
      if (mounted && Navigator.canPop(context)) Navigator.of(context).pop();
